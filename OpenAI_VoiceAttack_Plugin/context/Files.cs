...
namespace OpenAI_VoiceAttack_Plugin
{
    ...
    public static class Files
    {
        ...
        /// <br /><br />
        /// Returns are set to the VA text variable 'OpenAI_Response' as the OpenAI API id of
        /// the uploaded file (if successful) or blank if otherwise, and a success/failure 
        /// message in the 'OpenAI_TTS_Response' text variable.
        /// </summary>
        ...
        public static async Task Upload()
        {
            ...
            {
                throw new Exception("File path in OpenAI_FilePath text variable is null or empty!");
            }
        ...
        /// <br /><br />
        /// Returns are set to the VA text variable 'OpenAI_Response' as a string containing
        /// a semicolon separated list of files, or an empty string if none exist (or otherwise).
        /// </summary>
        /// <exception cref="HttpRequestException">Thrown when an error occurs while getting files data using GetFilesAsync().</exception>
        ...
        /// <br /><br />
        /// Returns are set to the VA text variable 'OpenAI_Response' as the OpenAI API id of
        /// the deleted file (if successful) or blank if otherwise, and a success/failure message
        /// in the 'OpenAI_TTS_Response' text variable.
        /// </summary>
        /// <exception cref="HttpRequestException">Thrown when an error occurs while getting files data using GetFilesAsync().</exception>
        public static async Task Delete()
        {
            ...
            {
                throw new Exception("File name in OpenAI_FileName text variable is null or empty!");
            }
